...
/*****************************************************************************/
	#define APPLICATION_VERSION							189
...
/*****************************************************************************/
	...
	#define _Pa_SNI_Clk				PFDR
	#define _Pin_SNI_Clk			5

	#define _Pa_SNI_In				PFDR
	#define _Pin_SNI_In				6
	...
	//PF5 = IN  - N_INF - Namur Down	-	SNI_CLK
	//PF6 = IN  - N_SUP - Namur Up		-	SNI_Data_In
