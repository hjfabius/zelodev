...
1461                     ; 30 }
1464  002b 81            	ret
1508                     ; 33 void timersSet(BYTE a_byIndex, BYTE a_byTimeoutValue)
1508                     ; 34 {
1509                     	switch	.text
...
1517                     ; 36 	m_arbyTimeouts[a_byIndex] = a_byTimeoutValue;
1519  0030 d70000        	ld	(_m_arbyTimeouts,x),a
1520                     ; 37 	_bres(m_byTimersFlag, a_byIndex);
