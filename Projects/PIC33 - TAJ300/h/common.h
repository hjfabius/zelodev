	...
	#define APPLICATION_VERSION								310
	...
	#define OSCILLATOR_FREQUENCY	(QUARTZ_MHZ*1000000UL)    /* 20 MHz */
	#define SPI_MANUAL
	...
	#define PIN_LED_RED				PORTBbits.RB15

	#define PIN_GATE				PORTAbits.RA0
	...
	#define PIN_AMPLY_0				PORTBbits.RB10
	#define PIN_AMPLY_1				PORTBbits.RB11
	...
	#define PIN_DDASK				PORTBbits.RB8	/* 	OUTPA1	DDASK		-->		DDASK	When PIC wants to start communication set this bit */
