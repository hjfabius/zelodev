	...
	#define _Pa_AuxIn_2				PADR
	#define _Pin_AuxIn_2			6

	#define _Pa_Opto_1				PFDR
	#define _Pin_Opto_1				0
...
/*****************************************************************************/
	...
	#define MEASURE_AVG_FIELDS  0x20   			//Average on 32 measures
	...
	#define ACCEPTABLE_DELTA_VISCOSITY		(WORD) 0x1FFF
	#define ACCEPTABLE_DELTA_TEMPERATURE	(BYTE) 0x30 	
	#define ACCEPTABLE_DELTA_PH				(BYTE) 0x30 	
