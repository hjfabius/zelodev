Public Class InLineRotoMark
    ...
    Private Sub InLineMark_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        Dim objMark As Mark
        Dim i As Integer
        If Not m_arobjMarks Is Nothing AndAlso _
            ...
            For i = 0 To m_arobjMarks.Count - 1
                ...
                If i = 0 Then
                    ...
                    End If
                Else
                    If Not Me.Controls("guiMark" & i) Is Nothing Then
                        If objMark.Active Then
