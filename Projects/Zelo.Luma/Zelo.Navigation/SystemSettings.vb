Public Class SystemSettings
    ...
    '        AddHandler CType(m_drGroupRow.RegisterRow.Table, Zelo.Luma.DSJobs.RegistersDataTable).RegistersChangedEvent, AddressOf RegistersChangedEventHandler
    ...
    '        RemoveHandler CType(m_drGroupRow.RegisterRow.Table, Zelo.Luma.DSJobs.RegistersDataTable).RegistersChangedEvent, AddressOf RegistersChangedEventHandler
    ...
    '        pnlRegister.Visible = (Not m_drGroupRow Is Nothing) AndAlso m_drGroupRow.IsInstalled AndAlso (Not m_drGroupRow.RegisterRow Is Nothing) AndAlso (m_drGroupRow.RegisterRow.IsInstalled)
    ...
    '            If m_drGroupRow.RegisterRow.IsBaseColor Then
    '                txtBaseColor.Text = "Yes"
    '            Else
    '                txtBaseColor.Text = "No"
    '            End If

    '            If CType(m_drGroupRow.RegisterRow.LateralMode, Mode) = Mode.Off Then
    '                txtActiveLateral.Text = "No"
    '            Else
    '                txtActiveLateral.Text = "Yes"
    '            End If

    '            If CType(m_drGroupRow.RegisterRow.LongitudinalMode, Mode) = Mode.Off Then
    '                txtActiveLongitudinal.Text = "No"
    '            Else
    '                txtActiveLongitudinal.Text = "Yes"
    '            End If

    '            txtMarkNumber.Text = (m_drGroupRow.RegisterRow.MarkID + 1).ToString


    '            If CType(m_drGroupRow.RegisterRow.Side, Side) = Side.BackSide Then
    ...
    '            txtRegisterCyclic.Text = m_drGroupRow.RegisterRow.Cyclic.ToString
    '            txtCylinderLength.Text = m_drGroupRow.RegisterRow.CylinderLength.ToString
    ...
    '            End If
    '            txtViscosityReal.Text = (m_drGroupRow.ViscositiesRow.ViscosityValue * m_drGroupRow.ViscositiesRow.ViscosityFactor) & "s"
    ...
    '            txtTemperatureReal.Text = (m_drGroupRow.ViscositiesRow.TemperatureValue * m_drGroupRow.ViscositiesRow.TemperatureFactor) & "°"
    ...
    '        'Group Color
    '        If (pnlRegister.Visible AndAlso CType(m_drGroupRow.RegisterRow.LateralMode, Mode) <> Mode.Off) Or _
    ...
    '        If CType(m_drGroupRow.RegisterRow.Side, Side) = Side.FrontSide Then
    '            m_drGroupRow.RegisterRow.Side = Side.BackSide
    '        Else
    '            m_drGroupRow.RegisterRow.Side = Side.FrontSide
    '        End If
    '    End Sub
    ...
    '        If CType(m_drGroupRow.RegisterRow.LongitudinalMode, Mode) = Mode.Off Then
    '            m_drGroupRow.RegisterRow.LongitudinalMode = Mode.Manual
    '        Else
    '            m_drGroupRow.RegisterRow.LongitudinalMode = Mode.Off
    '        End If
    '    End Sub
    ...
    '        If CType(m_drGroupRow.RegisterRow.LateralMode, Mode) = Mode.Off Then
    '            m_drGroupRow.RegisterRow.LateralMode = Mode.Manual
    '        Else
    '            m_drGroupRow.RegisterRow.LateralMode = Mode.Off
    '        End If
    '    End Sub

    '    Private Sub txtBaseColor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBaseColor.Click
    '        m_drGroupRow.RegisterRow.IsBaseColor = Not m_drGroupRow.RegisterRow.IsBaseColor
    '    End Sub
    ...
    '        SelectItemValue(txtRegisterCyclic, "Cycle", CSng(m_drGroupRow.RegisterRow.Cyclic), False)
    '    End Sub
    ...
    '        SelectItemValue(txtCylinderLength, "Cylinder Lenght", CSng(m_drGroupRow.RegisterRow.CylinderLength), False)
    '    End Sub
    ...
    '                m_drGroupRow.RegisterRow.CylinderLength = CInt(m_guiCalculator.Value)
    '            Case txtRegisterCyclic.Name
    '                m_drGroupRow.RegisterRow.Cyclic = CInt(m_guiCalculator.Value)
    '        End Select
    '        DeselectItem2()
    ...
    Public Overrides Sub LoadData()
        If Not Me.Demo Is Nothing AndAlso _
            Not Me.Demo.InLineGuide Is Nothing Then
            Me.cmdCommunicationPort.Text = Me.Demo.InLineGuide.SerialPort.ToString
        Else
            Me.cmdCommunicationPort.Text = ""
        End If
