...
/*****************************************************************************/
void screenDisplayValues(LWORD a_lwoValue1, LWORD a_lwoValue2, LWORD a_lwoValue3, LWORD a_lwoValue4, LWORD a_lwoValue5)
{
	BYTE strString[19];
	
	
	if(parametersGetValue(PARAM_PAGE) != PAGE_UNKNOWN_CODE)
	{
		displayClearArea(0, 0, 126, 126);
		displaySetOutLine(0, 0, 126, 126, false);
	}
	...
	strString[18] = 0x00;
	memcpy(strString, "Value 1 =", 9); 
	formatNumberLong(a_lwoValue1, 9, 0, strString+9);
	displayWriteString(strString, DISPLAY_SELECT_FONT_5x7, 10, 10);
	
	strString[18] = 0x00;
	memcpy(strString, "Value 2 =", 9); 
	formatNumberLong(a_lwoValue2, 9, 0, strString+9);
	displayWriteString(strString, DISPLAY_SELECT_FONT_5x7, 10, 20);

	strString[18] = 0x00;
	memcpy(strString, "Value 3 =", 9); 
	formatNumberLong(a_lwoValue3, 9, 0, strString+9);
	displayWriteString(strString, DISPLAY_SELECT_FONT_5x7, 10, 30);

	strString[18] = 0x00;
	memcpy(strString, "Value 4 =", 9); 
	formatNumberLong(a_lwoValue4, 9, 0, strString+9);
	displayWriteString(strString, DISPLAY_SELECT_FONT_5x7, 10, 40);

	strString[18] = 0x00;
	memcpy(strString, "Value 5 =", 9); 
	formatNumberLong(a_lwoValue5, 9, 2, strString+9);
	displayWriteString(strString, DISPLAY_SELECT_FONT_5x7, 10, 50);
		...
		if (parametersGetValue(PARAM_PAGE) != *a_byPage)
		{
			...
			switch(*a_byPage)
			{
				case PAGE_P1_VALUE:
					...
					formatNumber(parametersGetValue(PARAM_CYLINDER_TRAVEL), 7, 1, m_strString2);
					break;
				case PAGE_P2_VALUE:
					screenPrepareStdMessage(SCREEN_STD_MSG_ALLARM);
					formatNumber(parametersGetValue(PARAM_ALARM_BOUND), 5, 0, m_strString2);
					break;
				case PAGE_P3_VALUE:
					m_byDecimal = 1;
					screenPrepareStdMessage(SCREEN_STD_MSG_GATE_WINDOW);
					formatNumber(parametersGetValue(PARAM_GATE_WINDOW), 7, 1, m_strString2);
					break;
				case PAGE_P5_VALUE:
					screenPrepareStdMessage(SCREEN_STD_MSG_PARAM_5);
					formatNumber(parametersGetValue(PARAM_BASE_VALUE_DAC), 5, 0, m_strString2);
					break;
				case PAGE_COR_MINUS:
				...
				case PAGE_ARCHIVE_LOAD:
					...
					formatNumber(0, 5, 0, m_strString2);
					break;
				case PAGE_MM_01_VALUE:
					m_byDecimal = 0;
					screenPrepareStdMessage(SCREEN_STD_MSG_MM_POS_01);
					formatNumber(parametersGetValue(PARAM_MM_POSITION_01), 7, 0, m_strString2);
					break;
				case PAGE_MM_02_VALUE:
					m_byDecimal = 0;
					screenPrepareStdMessage(SCREEN_STD_MSG_MM_POS_02);
					formatNumber(parametersGetValue(PARAM_MM_POSITION_02), 7, 0, m_strString2);
					break;
		...
		case PARAM_LANGUAGE_EN: //English
			switch(a_byStdMessage)
			{
				...
				case SCREEN_STD_MSG_PARAM_5:
					...
					break;					
				case SCREEN_STD_MSG_MM_POS_01:
					memcpy(m_strString1, "Reference position", 20);
					//memcpy(m_strString2, "        position", 20);
					break;					
				case SCREEN_STD_MSG_MM_POS_02:
					memcpy(m_strString1, "Signal position", 20);
					//memcpy(m_strString2, "        position", 20);
					break;					
				default:
					break;
		...
		case PARAM_LANGUAGE_DE: //Deutch
			switch(a_byStdMessage)
			{
				...
				case SCREEN_STD_MSG_PARAM_5:
					...
					break;	
				case SCREEN_STD_MSG_MM_POS_01:
					memcpy(m_strString1, "Referenz Positionen", 20);
					//memcpy(m_strString2, "        Lage", 20);
					break;					
				case SCREEN_STD_MSG_MM_POS_02:
					memcpy(m_strString1, "Signal Positionen", 20);
					//memcpy(m_strString2, "        Lage", 20);
					break;					
				default:
					break;
			...
			switch(a_byStdMessage)
			{
				...
				case SCREEN_STD_MSG_PARAM_5:
					...
					break;			
				case SCREEN_STD_MSG_MM_POS_01:
					memcpy(m_strString1, "Position reference", 20);
					//memcpy(m_strString2, "        position", 20);
					break;					
				case SCREEN_STD_MSG_MM_POS_02:
					memcpy(m_strString1, "Position signal", 20);
					//memcpy(m_strString2, "        position", 20);
					break;						
				default:
					break;
		...
		case PARAM_LANGUAGE_ES: //Spanish
			switch(a_byStdMessage)
			{
				...
				case SCREEN_STD_MSG_PARAM_5:
					...
					break;				
				case SCREEN_STD_MSG_MM_POS_01:
					memcpy(m_strString1, "Posicion referencia", 20);
					//memcpy(m_strString2, "        posicion", 20);
					break;					
				case SCREEN_STD_MSG_MM_POS_02:
					memcpy(m_strString1, "Posicion senal", 20);
					//memcpy(m_strString2, "        posicion", 20);
					break;						
				default:
					break;
		...
		default:  	//PARAM_LANGUAGE_IT - Italian
			switch(a_byStdMessage)
			{
				...
				case SCREEN_STD_MSG_PARAM_5:
					...
					break;					
				case SCREEN_STD_MSG_MM_POS_01:
					memcpy(m_strString1, "Posiz. riferimento", 20);
					//memcpy(m_strString2, "        posizione", 20);
					break;					
				case SCREEN_STD_MSG_MM_POS_02:
					memcpy(m_strString1, "Posizione segnale", 20);
					//memcpy(m_strString2, "        posizione", 20);
					break;						
				default:
					break;
